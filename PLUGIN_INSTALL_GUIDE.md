...
```bash
git clone https://github.com/sakamoto66/claude-plugins.git
cd claude-plugins
```
...
```json
{
  "plugins": [
    {
      "name": "m5-claude-notify",
      "path": "C:\\projects\\claude-plugins"
    }
  ]
}
```
        ...
        "hooks": [
          {
            ...
            "command": "python",
            "args": [
              "C:\\projects\\claude-plugins\\hook\\client.py",
              "--hook-type",
              "permission"
            ],
            "timeout": 90
...
```powershell
python C:\projects\claude-plugins\hook\client.py --test
```
...
```json
{
  "plugins": [
    {
      "name": "m5-claude-notify",
      "path": "/home/username/claude-plugins"
    }
  ]
}
```
        ...
        "hooks": [
          {
            ...
            "command": "python3",
            "args": [
              "/home/username/claude-plugins/hook/client.py",
              "--hook-type",
              "permission"
            ],
            "timeout": 90
...
```bash
python3 /home/username/claude-plugins/hook/client.py --test
```
